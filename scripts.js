// Essa função é responsável por ao evento de clique e arraste em uma tarefa, ela mude de opacidade
...
// Essa função é responsável pelo evento de arrastar alguma coisa para algum lugar
